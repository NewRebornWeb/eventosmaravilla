...
<body>
	...
	<section class="titulo-paquetes">
		<div class="text-center itemBanner">
			<h2 class="text-capitalize text-black">Nuestro paquete</h2>
			<h1 class="text-none fw-bold text-black ">Los mejores paquetes para los mejores eventos</h1>
		</div>
	</section>
	<section class="eventos">
		<div class="evento">
			<div class="evento-der">
				<h2>Ofrecemos organización de todo tipo de Eventos</h2>
				<p>Apartando desde un precio inicial de $10,000.00 pesos de anticipo</p>
			</div>
			<div class="evento-izq"></div>
		</div>
		<div class="evento">
			<div class="evento-izq">
				<iframe width="850" height="400" src="https://www.youtube.com/embed/G_OsKIc-L58?start=27" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class="evento-der">
				<h2>Yelapa, Jaliso, México</h2>
				<p>Disfruta de tus eventos en la hermosa isla de Yelapa, las mejores vistas, aguas cristalinas y gente maravillosa.</p>
			</div>
		</div>
	</section>
